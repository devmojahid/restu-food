...
use Modules\Frontend\Services\CheckoutService;  
...
final class CheckoutController extends Controller
{
    ...
    public function index(): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout/Index', $data);
        } catch (\Throwable $e) {
            report($e);
            return Inertia::module('Frontend::Checkout/Index', [
    ...
    public function success(): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout/Success', $data);
        } catch (\Throwable $e) {
            report($e);
            return Inertia::module('Frontend::Checkout/Success', [
                'error' => $this->getSafeErrorMessage($e)
            ]);
        }
    }
    ...
    public function tracking(string $id): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout/Tracking', $data);
        } catch (\Throwable $e) {
            report($e);
            return Inertia::module('Frontend::Checkout/Tracking', [
                'error' => $this->getSafeErrorMessage($e)
            ]);
        }
    }
