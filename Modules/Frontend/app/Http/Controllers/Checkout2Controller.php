...
use Modules\Frontend\Services\Checkout2Service; 
...
final class Checkout2Controller extends Controller
{
    ...
    public function index(): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout2/Index', $data);  
        } catch (\Throwable $e) {
            return Inertia::module('Frontend::Checkout2/Index', [
    ...
    public function success(Request $request): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout2/Success', $data);
        } catch (\Throwable $e) {
            return Inertia::module('Frontend::Checkout2/Success', [
