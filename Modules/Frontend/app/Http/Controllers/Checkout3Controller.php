...
use Modules\Frontend\Services\Checkout3Service; 
...
final class Checkout3Controller extends Controller
{
    ...
    public function index(): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout3/Index', $data);  
        } catch (\Throwable $e) {
            return Inertia::module('Frontend::Checkout3/Index', [
    ...
    public function success(Request $request): Response
    {
        try {
            ...
            return Inertia::module('Frontend::Checkout3/Success', $data);
        } catch (\Throwable $e) {
            return Inertia::module('Frontend::Checkout3/Success', [
