...
use Modules\Frontend\Services\OrderTrackingService;  
...
final class OrderTrackingController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        try {
            ...
            return Inertia::module('Frontend::OrderTracking/Index', $data);  
        } catch (\Throwable $e) {
    ...
    {
        return Inertia::module('Frontend::OrderTracking/Index', [
            'hero' => [
