    ...
    items: [
      {
        title: "Security",
        icon: <Lock size={18} />,
        href: route("app.settings.security"),
      ...
      },
      {
        ...
        href: route("app.settings.localization"),
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <Chrome size={18} />,
        href: route("app.settings.google"),
      ...
      },
      {
        title: "Social Media",
        icon: <Share2 size={18} />,
        href: route("app.settings.social"),
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: "Notifications",
        icon: <Bell size={18} />,
        href: route("app.settings.notifications"),
